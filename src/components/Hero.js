    ...
    return (
        ...
        >
            ...
            <div className="md:w-1/2 space-y-5 text-center md:text-left">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-800">I'm <span className="text-blue-600">Muhammad Hammad</span></h1>
                ...
                <div className="flex gap-4 justify-center md:justify-start items-center text-blue-600 text-xl">
                    ...
                    <a href="https://github.com/HameyDev" target="_blank" rel="noopener noreferrer">
                        <FaGithub />
                    </a>
                    <a href="https://mailto:mhammad.zulfiqar.se@gmail.com">
                        <FaEnvelope />
                    </a>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6 mt-6 justify-center md:justify-start">
                    {/* Years Experience */}
