...
import { tabs, labels } from "../data/tabsData";
import {
  technicalSkills,
  softSkills,
  tools,
...
export default function SkillsTabs() {
  ...
  return (
    ...
    >
      ...
      {/* Tabs */}
      <div className="relative w-fit mx-auto mb-10 bg-white p-1 rounded-full shadow-inner flex">
        {/* Sliding Background */}
        <span
          ...
          {activeTab === "soft" && (
            ...
            >
              {softSkills.map((skill, i) => (
                <div
                  key={i}
                  className="bg-white p-4 rounded-lg shadow text-center space-y-2 transform duration-300 hover:-translate-y-1 hover:shadow-blue-600"
                >
              ...
              <div>
                ...
                <div className="space-y-3 ">
                  {tools.development.map((tool, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-3 bg-white px-4 py-3 rounded-lg shadow-sm transform duration-300 hover:-translate-y-1 hover:shadow-blue-600"
                    >
