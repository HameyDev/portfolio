      ...
      <AnimatePresence mode="wait">
        {activeTab === "formal" ? (
          ...
          >
            {[ /* Certificates Array */ 
              {
                logo: <FaFacebookF className="bg-[#1877F2] w-8 h-8 rounded-full p-1 text-white" />,
                title: "Meta Front-End Developer",
                provider: "Coursera",
                year: "2024",
              },
              {
                logo: <FaGoogle className="bg-[#DB4437] w-8 h-8 rounded-full p-1 text-white" />,
                title: "Google UX Design",
                provider: "Coursera",
                year: "2023",
              },
              {
                logo: <FaReact className="bg-[#5d068f] w-8 h-8 rounded-full p-1 text-white" />,
                title: "React + TypeScript",
                provider: "Udemy",
                year: "2022",
              },
              {
                logo: <FaFreeCodeCamp className="bg-[#0e7760] w-8 h-8 rounded-full p-1 text-white" />,
                title: "Responsive Web Design",
                provider: "freeCodeCamp",
                year: "2021",
              },
              {
                logo: <FaAws className="bg-[#FF9900] w-8 h-8 rounded-full p-1 text-white" />,
                title: "AWS Cloud Practitioner",
                provider: "Amazon",
                year: "2024",
              },
              {
                logo: <FaMicrosoft className="bg-[#0078D4] w-8 h-8 rounded-full p-1 text-white" />,
                title: "Microsoft Azure Fundamentals",
                provider: "Microsoft",
                year: "2023",
              },
              {
                logo: <FaLinux className="bg-[#FCC624] w-8 h-8 rounded-full p-1 text-black" />,
                title: "Linux for Developers",
                provider: "Linux Foundation",
                year: "2022",
              },
              {
                logo: <FaGraduationCap className="bg-[#2A73CC] w-8 h-8 rounded-full p-1 text-white" />,
